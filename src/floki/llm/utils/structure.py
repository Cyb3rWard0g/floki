...
from floki.types import StructureError, OAIJSONSchema, OAIResponseFormatSchema
...
class StructureHandler:
    ...
    def generate_request(
        ...
        **params
        ...
        """
        Generate a structured request for the language model based on the given mode.
